...
- Designed and implemented **Medallion architecture** **Databricks Job** to analyze a simulated data set using **meta data driven transformations**, **CI/CD** pipelines, **data quality** measures, and **auditability** tracking using **Kimball** data model
